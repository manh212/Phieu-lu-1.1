...
import type { ResponseLength, WorldSettings, TuChatTier } from '@/types/index';
...
export const VIETNAMESE_TRANSLATIONS = {
  ...
  parameterSettings: "Cài đặt tham số",
  parameterSettingsTitle: "Cài đặt tham số AI",
  temperatureLabel: "Nhiệt độ (Temperature)",
  temperatureDescription: "Kiểm soát sự sáng tạo/ngẫu nhiên. Giá trị cao hơn (vd: 0.9) tạo ra các phản hồi đa dạng hơn. Giá trị thấp hơn (vd: 0.2) làm cho AI tập trung hơn. (Mặc định: 0.8)",
  topKLabel: "Top-K",
  topKDescription: "Giới hạn các lựa chọn token tiếp theo cho AI. Giá trị nhỏ hơn làm cho AI ít ngẫu nhiên hơn. (Mặc định: 64)",
  topPLabel: "Top-P",
  topPDescription: "Một cách khác để kiểm soát sự ngẫu nhiên bằng cách chọn từ các token có xác suất tích lũy cao nhất. (Mặc định: 0.95)",
  thinkingConfigLabel: "Bật 'Suy nghĩ' (Thinking)",
  thinkingConfigDescription: "Chỉ dành cho model gemini-2.5-flash. Bật tính năng này cho phép AI dành thời gian suy nghĩ để có câu trả lời chất lượng cao hơn. Tắt sẽ cho phản hồi nhanh hơn, phù hợp với các tình huống cần độ trễ thấp. (Mặc định: Bật)",
  parameterSettingsSavedMessage: "Cài đặt tham số đã được lưu thành công!",
  ...
  invalidWorldSettingsFile: "File thiết lập thế giới không hợp lệ.",
  ...
  locationType_LANDMARK: "Địa danh đặc biệt (Độc lập)",
  ...
  statFear: "Sợ Hãi",
  statTrust: "Tin Tưởng",
  findLocationButtonTitle: "Tìm Kiếm Địa Điểm",
  findLocationButtonLabel: "Tìm Kiếm",
  returnToGame: "Quay Lại Cuộc Phiêu Lưu",
  findingLocationMessage: "Đang tìm kiếm địa điểm...",
  errorFindingLocation: "Lỗi khi tìm kiếm địa điểm",
  findLocationModalTitle: "Tìm Kiếm Địa Điểm",
  findLocationTypeLabel: "Loại Địa Điểm",
  findLocationPropertiesLabel: "Đặc Tính",
  ...
  errorCultivating: "Lỗi khi tu luyện.",
  cultivationScreenTitle: "Tu Luyện",
  exitCultivationButton: "Kết Thúc Tu Luyện",
  methodCultivationTab: "Tu Luyện Công Pháp",
  skillCultivationTab: "Tu Luyện Kỹ Năng",
  selectSkillToCultivate: "Chọn Linh Kĩ để tu luyện",
  noSkillsToCultivate: "Không có Linh Kĩ nào để tu luyện.",
  selectCultivationMethod: "Chọn phương thức tu luyện",
  closedDoorCultivation: "Bế Quan",
  dualCultivation: "Song Tu",
  noDualCultivationMethod: "Không có công pháp Song Tu.",
  noDualCultivationPartnerAvailable: "Không có đạo hữu nào để Song Tu.",
  selectDualCultivationPartner: "Chọn bạn đồng tu",
  cultivationDurationLabel: "Thời gian tu luyện",
  ...
  noPrisoners: "Không có tù nhân nào.",
  statAffinity: "Thiện Cảm",
  actionInputPlaceholder: "Nhập hành động của bạn...",
  ...
  daoLuTab: "Đạo Lữ",
  nuNoTab: "Nữ Nô",
  noWives: "Chưa có đạo hữu nào.",
  noSlaves: "Chưa có nữ nô nào.",
  companionManagementButton: "Quản Lý Hậu Cung",
  prisonerManagementButton: "Quản Lý Tù Nhân",
  cultivationButton: "Tu Luyện",
  prisonerConversionError: "Lỗi khi chuyển đổi thân phận tù nhân.",
  prisonerConverted: (name: string, type: 'wife' | 'slave') => `${name} đã được chuyển thành ${type === 'wife' ? 'Đạo Lữ' : 'Nô Lệ'}.`,
  fleeAttempt: "Thử bỏ chạy",
  combatVictory: "Thắng Lợi!",
  combatDefeat: "Thất Bại!",
  combatEscaped: "Bỏ Chạy!",
