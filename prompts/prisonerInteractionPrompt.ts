...
export const generatePrisonerInteractionPrompt = (
    ...
    // Thêm hướng dẫn đặc biệt cho Tù Nhân khi chế độ 18+ đang bật
...
1.  **VIẾT LỜI KỂ:**
    ...
    *   Nếu chế độ 18+ BẬT và hành động mang tính chất tình dục, hãy mô tả cảnh đó theo phong cách "${worldConfig?.nsfwDescriptionStyle}" đã được chỉ định.
