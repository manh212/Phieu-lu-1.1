...
const QuestsSidePanel: React.FC<QuestsSidePanelProps> = React.memo(({ quests, onQuestClick, onQuestEditClick, onCancelAllActiveQuests /*, onClose */ }) => {
  return (
    // OffCanvasPanel will handle the title and close button.
    // This component now just renders its content.
    <div className="flex flex-col h-full">
      <QuestsDisplayPanel quests={quests} onQuestClick={onQuestClick} onQuestEditClick={onQuestEditClick} onCancelAllActiveQuests={onCancelAllActiveQuests} />
    </div>
  );
});
